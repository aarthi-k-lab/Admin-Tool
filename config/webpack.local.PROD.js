  ...
  baseConfig,
  {
    ...
    devServer: {
      ...
      proxy: {
        ...
        '/api/ods-gateway': {
          target: 'https://prod.cmod.mrcooper.io/cmodgateway',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/ods-gateway': '',
        ...
        '/api/config': {
          target: 'https://prod.cmod.mrcooper.io/cmodspringconfig',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
        ...
        '/api/stager': {
          target: 'https://prod.cmod.mrcooper.io/cmodstager',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/stager': '',
        ...
        '/api/disposition': {
          target: 'https://prod.cmod.mrcooper.io/cmoddisposition',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/disposition': '',
        ...
        '/api/workassign': {
          target: 'https://prod.cmod.mrcooper.io/cmodworkassignment',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/workassign': '',
        ...
        '/api/data-aggregator': {
          target: 'https://prod.cmod.mrcooper.io/cmoddataaggregator',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/data-aggregator': '',
        ...
        '/api/userskills': {
          target: 'https://prod.cmod.mrcooper.io/cmoduserskill',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/userskills': '',
        ...
        '/api/release': {
          target: 'https://prod.cmod.mrcooper.io/cmodactivate',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/release': '',
        ...
        '/api/tkams': {
          target: 'https://prod.cmod.mrcooper.io/cmodtkams',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/tkams': '',
        ...
        '/api/bpm-audit': {
          target: 'https://prod.cmod.mrcooper.io/cmodbpmaudit',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/bpm-audit': '',
        ...
        '/api/task-engine': {
          target: 'https://prod.cmod.mrcooper.io/cmodtaskengine',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/task-engine': '/api',
          ...
          '/api/document': {
            target: 'https://prod.cmod.mrcooper.io/cmoddocument',
            secure: false,
            changeOrigin: true,
            pathRewrite: {
              '^/api/document': '',
        ...
        '/api/utility': {
          target: 'https://prod.cmod.mrcooper.io/cmodutility',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/utility': '',
        ...
        '/api/cmodtrial': {
          target: 'https://prod.cmod.mrcooper.io/cmodtrial',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/cmodtrial': '',
        ...
        '/api/cmodnetcoretkams': {
          target: 'https://prod.cmod.mrcooper.io/cmodtkamsnetcore',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/cmodnetcoretkams': '',
        ...
        '/api/dataservice': {
          target: 'https://prod.cmod.mrcooper.io/cmoddataservice',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/dataservice': '',
        ...
        '/api/docfulfillment': {
            target: 'https://prod.cmod.mrcooper.io/cmoddocfulfillment',
            secure: false,
            changeOrigin: true,
            pathRewrite: {
              '^/api/docfulfillment': '',
