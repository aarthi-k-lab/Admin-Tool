  ...
  baseConfig,
  {
    ...
    devServer: {
      ...
      proxy: {
        ...
        '/api/ods-gateway': {
          target: 'https://uat.cmod.mrcooper.io/cmodgateway',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/ods-gateway': '',
        ...
        '/api/config': {
          target: 'https://uat.cmod.mrcooper.io/cmodspringconfig',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
        ...
        '/api/stager': {
          target: 'https://uat.cmod.mrcooper.io/cmodstager',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/stager': '',
        ...
        '/api/disposition': {
          target: 'https://uat.cmod.mrcooper.io/cmoddisposition',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/disposition': '',
        ...
        '/api/workassign': {
          target: 'https://uat.cmod.mrcooper.io/cmodworkassignment',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/workassign': '',
        ...
        '/api/search-svc': {
          target: 'https://uat.cmod.mrcooper.io/cmodsearchengine',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/search-svc': '',
        ...
        '/api/userskills': {
          target: 'https://uat.cmod.mrcooper.io/cmoduserskill',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/userskills': '',
        ...
        '/api/release': {
          target: 'https://uat.cmod.mrcooper.io/cmodactivate',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/release': '',
        ...
        '/api/tkams': {
          target: 'https://uat.cmod.mrcooper.io/cmodtkams',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/tkams': '',
        ...
        '/api/bpm-audit': {
          target: 'https://uat.cmod.mrcooper.io/cmodbpmaudit',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/bpm-audit': '',
        ...
        '/api/task-engine': {
          target: 'https://uat.cmod.mrcooper.io/cmodtaskengine',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/task-engine': '/api',
        ...
        '/api/utility': {
          target: 'https://uat.cmod.mrcooper.io/cmodutility',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/utility': '',
        ...
        '/api/cmodtrial': {
          target: 'https://uat.cmod.mrcooper.io/cmodtrial',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/cmodtrial': '',
        ...
        '/api/cmodnetcoretkams': {
          target: 'https://uat.cmod.mrcooper.io/cmodtkamsnetcore',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/cmodnetcoretkams': '',
        ...
        '/api/dataservice': {
          target: 'https://uat.cmod.mrcooper.io/cmoddataservice',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/dataservice': '',
        ...
        '/api/docfulfillment': {
          target: 'https://uat.cmod.mrcooper.io/cmoddocfulfillment',
          secure: false,
          changeOrigin: true,
          pathRewrite: {
            '^/api/docfulfillment': '',
