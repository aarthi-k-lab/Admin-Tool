          ...
          <Grid item>
            <Grid container>
              ...
              <Grid item style={{ padding: '0px' }} xs={11}>
                <Typography styleName={`tag-dialog-content-main-name ${name.includes(DECEASED_BORROWER) ? 'user-disable' : ''}`}>
                  {R.pathOr('', [name, 'displayName'], borrowerNames)}
                </Typography>
                <Typography styleName={`tag-dialog-content-name ${name.includes(DECEASED_BORROWER) ? 'user-disable' : ''}`}>
    ...
    <Dialog open={tagPopover}>
      ...
      <DialogContent>
        <Grid container direction="column">
          <Grid item>
            <Grid container>
              <Grid item style={{ padding: '0px' }} xs={1}>
                <Checkbox
