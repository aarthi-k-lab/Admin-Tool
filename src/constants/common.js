...
const hideClearButton = ['sla-rules', 'income-calculator', 'asset-verification', 'fico-checklist', 'asset-checklist'];
const financialChecklist = ['income-calculator', 'asset-verification', 'fico-checklist', 'asset-checklist'];
