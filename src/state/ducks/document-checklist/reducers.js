...
const reducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case SET_LINK_DOC_STATUS: {
      return {
        ...state,
        isLinkingDoc: action.payload,
      };
    }
    case SET_INITIAL_DOC_CHK_DATA: {
      return {
        ...state,
        initialDocChecklistData: action.payload,
      };
    }
    case RESET_FILENET_DOC_TYPES: {
      return {
        ...state,
        filenetDocType: [],
      };
    }
    case SET_FILENET_CAT_TYPES: {
      return {
        ...state,
        filenetCatTypes: action.payload,
      };
    }
    case LOADER: {
      return {
